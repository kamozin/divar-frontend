<template>
  <div>
    <!--begin::Toolbar-->
    <toolbar page="Update Delivery Terms" page-create="/delivery-terms"></toolbar>
    <!--end::Toolbar-->
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.$axios.$get('/delivery-terms/'+this.$route.params.id)
        .then(response => {
    ...
    updateRecord () {
      ...
      this.$axios.$patch('/delivery-terms/'+this.form.id, this.form)
        .then(response => {
